            ...
            <section className='bg-slate-900' >
                ...
                <header className='flex justify-between items-center z-auto bg-slate-900 px-20 py-5'>
                    ...
                    <nav>
                        ...
                        <a className=' text-zinc-50 hover:text-lime-400 text-lg font-semibold ml-7' href="#">About</a>
                        <a className=' text-zinc-50 hover:text-lime-400 text-lg font-semibold ml-7' href="#">Services</a>
                        <a className=' text-zinc-50 hover:text-lime-400 text-lg font-semibold ml-7' href="#">Portfolio</a>
                        <a className=' text-zinc-50 hover:text-lime-400 text-lg font-semibold ml-7' href="#">Contact</a>
                    </nav>
                </header>
